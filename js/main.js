...
const translations = {
  pl: {
    ...
    'hero.sub':'Specjaliści od Toyota, Lexus, BMW, Mercedes i VW.<br>Diagnostyka, baterie HV, elektryka, rozrząd. Okęcie.',
  ...
  en: {
    ...
    'hero.sub':'Specialists in Toyota, Lexus, BMW, Mercedes and VW.<br>Diagnostics, HV batteries, electrics, timing. Okęcie.',
  ...
  ru: {
    ...
    'hero.sub':'Специалисты по Toyota, Lexus, BMW, Mercedes и VW.<br>Диагностика, батареи HV, электрика, ГРМ. Окенче.',
  ...
  ua: {
    ...
    'hero.title.city':'Варшава',
    'hero.sub':'Спеціалісти з Toyota, Lexus, BMW, Mercedes та VW.<br>Діагностика, батареї HV, електрика, ГРМ. Окенче.',
